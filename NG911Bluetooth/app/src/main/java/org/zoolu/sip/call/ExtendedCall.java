...
public class ExtendedCall extends Call implements ExtendedInviteDialogListener {
    ...
    /**
     * This method is called in UserAgent.java
     * when the emergency number is dialed
     * <p/>
     * It will redirect the flow to the method inviteNG911(...)
     * inside InviteDialog.java
     */
    public void callNG911(String r_user, String from, String contact, String sdp, String icsi) {
        ...
        if (sdp != null)
            local_sdp = sdp;
        if (local_sdp != null)
            dialog.inviteNG911(r_user, from, contact, local_sdp, icsi);        // modified by mandrajg
        else
            dialog.inviteNG911(r_user, from, contact, null, null);
    }
